...
dataset = {
    "inter_ua_zh": f"{BASE_DIR}/task3/inter/inter_sup_logic_ua_zh.json",
    "inter_ua_en": f"{BASE_DIR}/task3/inter/inter_sup_logic_ua_en.json",
    "inter_ab_zh": f"{BASE_DIR}/task3/inter/inter_sup_logic_ab_zh.json",
    "inter_ab_en": f"{BASE_DIR}/task3/inter/inter_sup_logic_ab_en.json",
}

dev_sets = {
    "inter_ua_zh": f"{BASE_DIR}/task3/dev/inter_zh.json",
    "inter_ua_en": f"{BASE_DIR}/task3/dev/inter_en.json",
    "inter_ab_zh": f"{BASE_DIR}/task3/dev/inter_zh.json",
