...
dataset = {
    "time_ua_zh": f"{BASE_DIR}/task3/time/time_sup_logic_ab_en.json",
    "time_ua_en": f"{BASE_DIR}/task3/time/time_sup_logic_ab_en.json",
    "time_ab_zh": f"{BASE_DIR}/task3/time/time_sup_logic_ab_en.json",
    "time_ab_en": f"{BASE_DIR}/task3/time/time_sup_logic_ab_en.json",
}

dev_sets = {
    "time_ua_zh": f"{BASE_DIR}/task3/dev/time_zh.json",
    "time_ua_en": f"{BASE_DIR}/task3/dev/time_en.json",
    "time_ab_zh": f"{BASE_DIR}/task3/dev/time_zh.json",
