...
dataset = {
    "time_ab_en": f"{BASE_DIR}/timeqa_ab_en_v2.json",
    # "time_ab_zh": f"{BASE_DIR}/timeqa_ab_zh_v2.json",
    "time_ua_en": f"{BASE_DIR}/timeqa_ua_en_v2.json",
    # "time_ua_zh": f"{BASE_DIR}/timeqa_ua_zh_v2.json",
}

dev_sets = {
    "time_ab_en": f"{BASE_DIR}/dev/time_en_dev.json",
    # "time_ab_zh": f"{BASE_DIR}/data/dev/time_zh_dev.json",
    "time_ua_en": f"{BASE_DIR}/dev/time_en_dev.json",
    # "time_ua_zh": f"{BASE_DIR}/data/dev/time_zh_dev.json",
}
...
if __name__ == "__main__":
    ...
    # file_save_path = os.path.join(save_prefix_path, "_arr_generate_until_main_time_4_shot.yaml")
    # arr_subcategories = [category for category in ALL_CATEGORIES]
    # group_data = {
    #     "group": f"arr_generate_until_main_time_4_shot",
