...
dataset = {
    # "dilemma_ua_zh": f"{BASE_DIR}/data/final_main_que/dilemma_ua_zh_v2.json",
    "dilemma_ua_en": f"{BASE_DIR}/dilemma_ua_en_v2.json",
    # "dilemma_ab_zh": f"{BASE_DIR}/data/final_main_que/dilemma_ab_zh_v2.json",
    "dilemma_ab_en": f"{BASE_DIR}/dilemma_ab_en_v2.json",
}

dev_sets = {
    "dilemma_ab_en": f"{BASE_DIR}/dev/dilemma_en_dev.json",
    # "dilemma_ab_zh": f"{BASE_DIR}/dev/dilemma_zh_dev.json",
    "dilemma_ua_en": f"{BASE_DIR}/dev/dilemma_en_dev.json",
    # "dilemma_ua_zh": f"{BASE_DIR}/dev/dilemma_zh_dev.json",
}
...
if __name__ == "__main__":
    ...
    file_save_path = os.path.join(save_prefix_path, "_arr_generate_until_main_dilemma_4_shot.yaml")
    arr_subcategories = [category for category in ALL_CATEGORIES]
    # group_data = {
    #     "group": f"arr_generate_until_main_dilemma_4_shot",
