...
dataset = {
    "dilemma_ua_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/dilemma/dilemma_sup_logic_ua_zh.json",
    # "dilemma_ua_en": f"{BASE_DIR}/task3/dilemma/dilemma_sup_logic_ua_en.json",
    "dilemma_ab_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/dilemma/dilemma_sup_logic_ab_zh.json",
    # "dilemma_ab_en": f"{BASE_DIR}/task3/dilemma/dilemma_sup_logic_ab_en.json",
}

dev_sets = {
    "dilemma_ua_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/dev/shuffled/dilemma_zh.json",
    # "dilemma_ua_en": f"{BASE_DIR}/task3/dev/dilemma_en.json",
    "dilemma_ab_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/dev/shuffled/dilemma_zh.json",
