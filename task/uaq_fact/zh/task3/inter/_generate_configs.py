...
dataset = {
    "inter_ua_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/inter/inter_sup_logic_ua_zh.json",
    # "inter_ua_en": f"{BASE_DIR}/task3/inter/inter_sup_logic_ua_en.json",
    "inter_ab_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/inter/inter_sup_logic_ab_zh.json",
    # "inter_ab_en": f"{BASE_DIR}/task3/inter/inter_sup_logic_ab_en.json",
}

dev_sets = {
    "inter_ua_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/dev/shuffled/inter_zh.json",
    # "inter_ua_en": f"{BASE_DIR}/task3/dev/inter_en.json",
    "inter_ab_zh": f"/public/home/hmqiu/cytan/llm_eval_wlchen/data/FUAQ/task3/dev/shuffled/inter_zh.json",
    # "inter_ab_en": f"{BASE_DIR}/task3/dev/inter_en.json",
}
...
if __name__ == "__main__":
    ...
    file_save_path = os.path.join(save_prefix_path, "_arr_generate_until_sup_logic_CoT_QA_inter.yaml")
    arr_subcategories = [category for category in ALL_CATEGORIES]
    group_data = {
        "group": f"arr_generate_until_sup_logic_CoT_QA_inter",
